...
import { DropnavDirective, DropParentIconDirective } from "ngx-uikit";
...
@Component({
  ...
  imports: [CommonModule, OptionsComponent, DemoTitleComponent, DropnavDirective, DropParentIconDirective],
