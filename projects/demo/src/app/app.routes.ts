...
import { uikitHelpLink } from "./components/demo-title/demo-title.component";
...
export const routes: Routes = [
  ...
  { path: "form-custom", loadComponent: () => import("./pages/form-custom/form-custom.component").then(c => c.FormCustomComponent), title: "form-custom", data: uikitHelpLink("form") },
  { path: "grid", loadComponent: () => import("./pages/grid/grid.component").then(c => c.GridComponent), title: "grid" },
  { path: "height-match", loadComponent: () => import("./pages/height-match/height-match.component").then(c => c.HeightMatchComponent), title: "height-match", data: uikitHelpLink("height") },
  { path: "height-placeholder", loadComponent: () => import("./pages/height-placeholder/height-placeholder.component").then(c => c.HeightPlaceholderComponent), title: "height-placeholder", data: uikitHelpLink("height") },
  { path: "height-viewport", loadComponent: () => import("./pages/height-viewport/height-viewport.component").then(c => c.HeightViewportComponent), title: "height-viewport", data: uikitHelpLink("height") },
  ...
  { path: "off-canvas", loadComponent: () => import("./pages/off-canvas/off-canvas.component").then(c => c.OffCanvasComponent), title: "off-canvas", data: uikitHelpLink("offcanvas") },
  ...
  { path: "tab", loadComponent: () => import("./pages/tab/tab.component").then(c => c.TabComponent), title: "tab" },
